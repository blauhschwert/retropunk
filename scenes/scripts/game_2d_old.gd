...
func build_level():
	...
	var free_regions = [Rect2i(Vector2i(2,2), level_size - Vector2i(4,4))]
...
func add_room(free_regions):
	...
	size_x = min(size_x, MAX_ROOM_DIEMENSION)
	size_y = min(size_y, MAX_ROOM_DIEMENSION)
